...
export const RegisterScreen = () => {
    const { signUpValues, handleSignUpInputChange, signUpOnSubmit } = useContext(GlobalContext);
    ...
    return (
        <div className='min-h-full flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8'>
            <div className='max-w-md w-full space-y-8'>
                ...
                <form autoComplete='off' className='mt-8 space-y-6' onSubmit={signUpOnSubmit}>
